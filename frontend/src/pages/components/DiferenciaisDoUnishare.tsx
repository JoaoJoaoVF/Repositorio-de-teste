        ...
        <div>
            <div className="container-fluid px-4 py-5 text-justify" id="icon-grid">
                ...
                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
                    ...
                    <div className="col">
                        <div className="d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 48 48"><mask id="ipSBlackboard0"><g fill="none" stroke-linejoin="round" stroke-width="4"><path fill="#fff" stroke="#fff" d="M8 7h32v24H8z" /><path stroke="#fff" stroke-linecap="round" d="M4 7h40M15 41l9-10l9 10" /><path stroke="#000" stroke-linecap="round" d="M16 13h16m-16 6h12m-12 6h6" /></g></mask><path fill="#9582a1" d="M0 0h48v48H0z" mask="url(#ipSBlackboard0)" /></svg>
                            <div className="ms-3">
                                <h2 className="fw-bold mb-0 fs-4 text-#9582a1">Avaliação de Professores</h2>
                                 <p className="text-#000000">Oferece a oportunidade de os alunos compartilharem suas opiniões e avaliações sobre os professores, auxiliando outros estudantes na escolha de cursos</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col">
                        <div className="d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 48 48"><mask id="ipTBackpack0"><g fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="4"><path d="M19 9.556V4h-6v10m16-4.444V4h6v10" /><path fill="#555" d="M11 20c0-5.523 4.477-10 10-10h6c5.523 0 10 4.477 10 10v20a4 4 0 0 1-4 4H15a4 4 0 0 1-4-4V20Z" /><path d="M11 29H5v10h6m26-10h6v10h-6m-9-16v4m-11-4h14" /></g></mask><path fill="#9582a1" d="M0 0h48v48H0z" mask="url(#ipTBackpack0)" /></svg>
                            <div className="ms-3">
                                <h2 className="fw-bold mb-0 fs-4 text-#9582a1">Simplificação da Vida Acadêmica</h2>
                                 <p className="text-#000000">Torna a vida acadêmica dos estudantes mais fácil, oferecendo recursos valiosos e insights úteis.</p>
                            </div>
                        </div>
                    </div>
